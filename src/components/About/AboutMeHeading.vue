<template>
  <div>
    <div v-observe-visibility="ObjectVisible" class="flex flex-row w-auto justify-center lg:justify-start  h-20 md:h-24 lg:h-32">
      ...
      <h1 class="portfolio-heading text-7xl flex py-4" v-show="letterVisible6"  v-bind:class="{ fadeSlideDown: isFade }">M</h1>
      <h1 class="portfolio-heading text-7xl flex py-4" v-show="letterVisible7"  v-bind:class="{ fadeSlideDown: isFade }">e</h1>
    </div>
  </div>
</template>
